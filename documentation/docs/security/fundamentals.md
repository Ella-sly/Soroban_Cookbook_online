...
**Prevention:** Follow the **Checks-Effects-Interactions** pattern. Update all internal state *before* calling external contracts.
...
- [ ] **State Changes:** Internal state is updated *before* any external contract calls.
